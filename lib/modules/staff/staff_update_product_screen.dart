...
class StaffUpdateProductScreen extends StatefulWidget {
  const StaffUpdateProductScreen({super.key, required this.name, required this.color, required this.price, required this.description, required this.productId});
  ...
  @override
  State<StaffUpdateProductScreen> createState() => _StaffUpdateProductScreenState();
}

class _StaffUpdateProductScreenState extends State<StaffUpdateProductScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    var request = http.MultipartRequest(
      'PUT',
      Uri.parse('${ApiService.baseUrl}/api/staff/update-product/${widget.productId}'),
    );
